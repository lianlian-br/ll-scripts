...
write_sources('/opt/SumoCollector/config', f'{env}/ec2/linux/{vpc}/{alias}', sources)
write_user_properties('/opt/SumoCollector/config', f'{env}-{vpc}-{alias}', access_id, access_key, fields)
